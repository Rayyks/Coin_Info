...
function GetStarted() {
  const stepsData = [
    ...
    },
    {
      title: "Buy NFT",
      description:
        "Explore and purchase unique NFTs from Cryptoace's collection. Own digital assets like never before.",
  ...
  return (
    <section className="bg-mainBg text-gray-300" id="getStarted">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2  mb-4">
          ...
          >
            ...
            <p className="font-raj text-center lg:text-left tracking-wider pt-2">
              Every transaction made from CoinInfo is safe and secured. You can
              also track any of your transactions on the metamask wallet and
              also on ehterscan.
              <span className="hidden lg:block">
                All the transactions on CoinInfo works transparently and hence
      ...
      {/*Get Started Section  */}
      <h2
        className="mx-auto max-w-md pt-10 lg:mb-10 font-rubik text-center font-extrabold tracking-wide text-3xl text-gray-300 sm:text-4xl sm:leading-none xl:max-w-lg"
        data-aos="fade-in"
      >
        Get{" "}
        <span className="inline-block text-logo-gradient" data-aos="fade-in">
          Started.
        </span>
      </h2>
            ...
            >
              ...
              {index % 2 === 0 ? (
                <>
                  ...
                  <div
                    className="flex-grow sm:text-left text-center mt-1 sm:mt-0"
                    data-aos="fade-right"
                    data-aos-duration="1000"
                  >
