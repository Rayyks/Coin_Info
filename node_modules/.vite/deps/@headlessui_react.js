import {
  require_react_dom
} from "./chunk-VE4RHMTG.js";
import {
  require_react
} from "./chunk-Z43DO6Z5.js";
import {
  __objRest,
  __spreadProps,
  __spreadValues,
...
function X({ ourProps: r9, theirProps: t17, slot: e5, defaultTag: a13, features: s17, visible: n7 = true, name: f14 }) {
  ...
  if (u10 & 2) {
    let _a = o12, { static: l11 = false } = _a, p7 = __objRest(_a, ["static"]);
    if (l11)
      return c3(p7, e5, a13, f14);
  }
  if (u10 & 1) {
    let _b = o12, { unmount: l11 = true } = _b, p7 = __objRest(_b, ["unmount"]);
    return u(l11 ? 0 : 1, { [0]() {
      return null;
    }, [1]() {
      return c3(__spreadProps(__spreadValues({}, p7), { hidden: true, style: { display: "none" } }), e5, a13, f14);
    } });
  }
  return c3(o12, e5, a13, f14);
}
function c3(r9, t17 = {}, e5, a13) {
  let _a = g(r9, ["unmount", "static"]), { as: s17 = e5, children: n7, refName: f14 = "ref" } = _a, o12 = __objRest(_a, ["as", "children", "refName"]), u10 = r9.ref !== void 0 ? { [f14]: r9.ref } : {}, l11 = typeof n7 == "function" ? n7(t17) : n7;
...
function s8(t17, o12) {
  let _a = t17, { features: n7 = 1 } = _a, e5 = __objRest(_a, ["features"]), d13 = { ref: o12, "aria-hidden": (n7 & 2) === 2 ? true : void 0, style: __spreadValues({ position: "fixed", top: 1, left: 1, width: 1, height: 0, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", borderWidth: "0" }, (n7 & 4) === 4 && (n7 & 2) !== 2 && { display: "none" }) };
...
var Ge = { [1](t17) {
  var a13;
  return (a13 = t17.dataRef.current) != null && a13.disabled || t17.comboboxState === 1 ? t17 : __spreadProps(__spreadValues({}, t17), { activeOptionIndex: null, comboboxState: 1 });
}, [0](t17) {
  var e5;
  ...
  return __spreadProps(__spreadValues({}, t17), { comboboxState: 0, activeOptionIndex: a13 });
}, [2](t17, a13) {
  var l11, b7, n7, d13;
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, t17), e5), { activeOptionIndex: r9, activationTrigger: (d13 = a13.trigger) != null ? d13 : 1 });
}, [3]: (t17, a13) => {
  var b7, n7;
  ...
  let l11 = __spreadProps(__spreadValues(__spreadValues({}, t17), r9), { activationTrigger: 1 });
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, t17), e5), { activationTrigger: 1 });
}, [5]: (t17, a13) => __spreadProps(__spreadValues({}, t17), { labelId: a13.id }) };
...
function Je(t17, a13) {
  let _a = t17, { value: e5, defaultValue: r9, onChange: l11, form: b7, name: n7, by: d13 = (u10, T8) => u10 === T8, disabled: o12 = false, __demoMode: i9 = false, nullable: A6 = false, multiple: O4 = false } = _a, C5 = __objRest(_a, ["value", "defaultValue", "onChange", "form", "name", "by", "disabled", "__demoMode", "nullable", "multiple"]), [f14 = O4 ? [] : void 0, g6] = T4(e5, l11, r9), [m11, c14] = (0, import_react19.useReducer)(Xe, { dataRef: (0, import_react19.createRef)(), comboboxState: i9 ? 0 : 1, options: [], activeOptionIndex: null, activationTrigger: 1, labelId: null }), D6 = (0, import_react19.useRef)(false), _7 = (0, import_react19.useRef)({ static: false, hold: false }), w6 = (0, import_react19.useRef)(null), U5 = (0, import_react19.useRef)(null), N7 = (0, import_react19.useRef)(null), K4 = (0, import_react19.useRef)(null), h11 = o4(typeof d13 == "string" ? (u10, T8) => {
    let v5 = d13;
    return (u10 == null ? void 0 : u10[v5]) === (T8 == null ? void 0 : T8[v5]);
  } : d13), H7 = (0, import_react19.useCallback)((u10) => u(p7.mode, { [1]: () => f14.some((T8) => h11(T8, u10)), [0]: () => h11(f14, u10) }), [f14]), p7 = (0, import_react19.useMemo)(() => __spreadProps(__spreadValues({}, m11), { optionsPropsRef: _7, labelRef: w6, inputRef: U5, buttonRef: N7, optionsRef: K4, value: f14, defaultValue: r9, disabled: o12, mode: O4 ? 1 : 0, get activeOptionIndex() {
  ...
  }, [z5, g6]), import_react19.default.createElement(le.Provider, { value: te4 }, import_react19.default.createElement(ie.Provider, { value: p7 }, import_react19.default.createElement(c5, { value: u(p7.comboboxState, { [0]: d5.Open, [1]: d5.Closed }) }, n7 != null && f14 != null && e2({ [n7]: f14 }).map(([u10, T8], v5) => import_react19.default.createElement(c4, __spreadValues({ features: p3.Hidden, ref: v5 === 0 ? (q5) => {
    var ue5;
...
function We(t17, a13) {
  var p7, y8, E9, B3;
  let e5 = I(), _a = t17, { id: r9 = `headlessui-combobox-input-${e5}`, onChange: l11, displayValue: b7, type: n7 = "text" } = _a, d13 = __objRest(_a, ["id", "onChange", "displayValue", "type"]), o12 = J("Combobox.Input"), i9 = Z("Combobox.Input"), A6 = y2(o12.inputRef, a13), O4 = n3(o12.inputRef), C5 = (0, import_react19.useRef)(false), f14 = p(), g6 = o4(() => {
...
function qe(t17, a13) {
  var g6;
  let e5 = J("Combobox.Button"), r9 = Z("Combobox.Button"), l11 = y2(e5.buttonRef, a13), b7 = I(), _a = t17, { id: n7 = `headlessui-combobox-button-${b7}` } = _a, d13 = __objRest(_a, ["id"]), o12 = p(), i9 = o4((m11) => {
    switch (m11.key) {
      case o8.ArrowDown:
...
var Qe = "label";
function Ye(t17, a13) {
  let e5 = I(), _a = t17, { id: r9 = `headlessui-combobox-label-${e5}` } = _a, l11 = __objRest(_a, ["id"]), b7 = J("Combobox.Label"), n7 = Z("Combobox.Label"), d13 = y2(b7.labelRef, a13);
...
function eo(t17, a13) {
  let e5 = I(), _a = t17, { id: r9 = `headlessui-combobox-options-${e5}`, hold: l11 = false } = _a, b7 = __objRest(_a, ["id", "hold"]), n7 = J("Combobox.Options"), d13 = y2(n7.optionsRef, a13), o12 = C(), i9 = (() => o12 !== null ? (o12 & d5.Open) === d5.Open : n7.comboboxState === 0)();
  l(() => {
    var f14;
...
function to(t17, a13) {
  var H7, p7;
  let e5 = I(), _a = t17, { id: r9 = `headlessui-combobox-option-${e5}`, disabled: l11 = false, value: b7 } = _a, n7 = __objRest(_a, ["id", "disabled", "value"]), d13 = J("Combobox.Option"), o12 = Z("Combobox.Option"), i9 = d13.activeOptionIndex !== null ? d13.options[d13.activeOptionIndex].id === r9 : false, A6 = d13.isSelected(b7), O4 = (0, import_react19.useRef)(null), C5 = s2({ disabled: l11, value: b7, domRef: O4, textValue: (p7 = (H7 = O4.current) == null ? void 0 : H7.textContent) == null ? void 0 : p7.toLowerCase() }), f14 = y2(a13, O4), g6 = o4(() => o12.selectOption(r9));
...
function X2(t17, r9) {
  let e5 = (0, import_react24.useRef)(null), o12 = y2(e5, r9), _a = t17, { initialFocus: u10, containers: i9, features: n7 = 30 } = _a, l11 = __objRest(_a, ["initialFocus", "containers", "features"]);
  l2() || (n7 = 1);
  let m11 = n3(e5);
...
function j2(p7, l11) {
  let _a = p7, { target: n7 } = _a, e5 = __objRest(_a, ["target"]), o12 = { ref: y2(l11) };
...
var S6 = "p";
function h5(r9, t17) {
  let a13 = I(), _a = r9, { id: e5 = `headlessui-description-${a13}` } = _a, i9 = __objRest(_a, ["id"]), n7 = f9(), s17 = y2(t17);
  l(() => n7.register(e5), [e5, n7.register]);
  let o12 = __spreadProps(__spreadValues({ ref: s17 }, n7.props), { id: e5 });
...
var Me = { [0](t17, e5) {
  return t17.titleId === e5.id ? t17 : __spreadProps(__spreadValues({}, t17), { titleId: e5.id });
} };
...
function Ne2(t17, e5) {
  var X5;
  let o12 = I(), _a = t17, { id: i9 = `headlessui-dialog-${o12}`, open: n7, onClose: l11, initialFocus: s17, __demoMode: g6 = false } = _a, T8 = __objRest(_a, ["id", "open", "onClose", "initialFocus", "__demoMode"]), [m11, h11] = (0, import_react30.useState)(0), a13 = C();
...
var Ue2 = "div";
function We2(t17, e5) {
  let o12 = I(), _a = t17, { id: i9 = `headlessui-dialog-overlay-${o12}` } = _a, n7 = __objRest(_a, ["id"]), [{ dialogState: l11, close: s17 }] = b3("Dialog.Overlay"), g6 = y2(e5), T8 = o4((a13) => {
...
var Ye2 = "div";
function $e2(t17, e5) {
  let o12 = I(), _a = t17, { id: i9 = `headlessui-dialog-backdrop-${o12}` } = _a, n7 = __objRest(_a, ["id"]), [{ dialogState: l11 }, s17] = b3("Dialog.Backdrop"), g6 = y2(e5);
...
var Je2 = "div";
function Xe2(t17, e5) {
  let o12 = I(), _a = t17, { id: i9 = `headlessui-dialog-panel-${o12}` } = _a, n7 = __objRest(_a, ["id"]), [{ dialogState: l11 }, s17] = b3("Dialog.Panel"), g6 = y2(e5, s17.panelRef), T8 = (0, import_react30.useMemo)(() => ({ open: l11 === 0 }), [l11]), m11 = o4((a13) => {
    a13.stopPropagation();
  });
...
var je2 = "h2";
function Ke2(t17, e5) {
  let o12 = I(), _a = t17, { id: i9 = `headlessui-dialog-title-${o12}` } = _a, n7 = __objRest(_a, ["id"]), [{ dialogState: l11, setTitleId: s17 }] = b3("Dialog.Title"), g6 = y2(e5);
...
var Q2 = { [0]: (e5) => __spreadProps(__spreadValues({}, e5), { disclosureState: u(e5.disclosureState, { [0]: 1, [1]: 0 }) }), [1]: (e5) => e5.disclosureState === 1 ? e5 : __spreadProps(__spreadValues({}, e5), { disclosureState: 1 }), [4](e5) {
  return e5.linkedPanel === true ? e5 : __spreadProps(__spreadValues({}, e5), { linkedPanel: true });
}, [5](e5) {
  return e5.linkedPanel === false ? e5 : __spreadProps(__spreadValues({}, e5), { linkedPanel: false });
}, [2](e5, n7) {
  return e5.buttonId === n7.buttonId ? e5 : __spreadProps(__spreadValues({}, e5), { buttonId: n7.buttonId });
}, [3](e5, n7) {
  return e5.panelId === n7.panelId ? e5 : __spreadProps(__spreadValues({}, e5), { panelId: n7.panelId });
} };
...
function ee2(e5, n7) {
  let _a = e5, { defaultOpen: o12 = false } = _a, u10 = __objRest(_a, ["defaultOpen"]), T8 = (0, import_react32.useRef)(null), l11 = y2(n7, T2((a13) => {
    T8.current = a13;
...
var te = "button";
function ne(e5, n7) {
  let o12 = I(), _a = e5, { id: u10 = `headlessui-disclosure-button-${o12}` } = _a, T8 = __objRest(_a, ["id"]), [l11, t17] = M5("Disclosure.Button"), f14 = V(), s17 = f14 === null ? false : f14 === l11.panelId, i9 = (0, import_react32.useRef)(null), c14 = y2(i9, n7, s17 ? null : l11.buttonRef);
...
function re(e5, n7) {
  let o12 = I(), _a = e5, { id: u10 = `headlessui-disclosure-panel-${o12}` } = _a, T8 = __objRest(_a, ["id"]), [l11, t17] = M5("Disclosure.Panel"), { close: f14 } = w4("Disclosure.Panel"), s17 = y2(n7, l11.panelRef, (P4) => {
    a10(() => t17({ type: P4 ? 4 : 5 }));
  });
...
var je3 = { [1](e5) {
  return e5.dataRef.current.disabled || e5.listboxState === 1 ? e5 : __spreadProps(__spreadValues({}, e5), { activeOptionIndex: null, listboxState: 1 });
}, [0](e5) {
  ...
  return r9 !== -1 && (a13 = r9), __spreadProps(__spreadValues({}, e5), { listboxState: 0, activeOptionIndex: a13 });
}, [2](e5, a13) {
  var l11;
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, e5), n7), { searchQuery: "", activeOptionIndex: r9, activationTrigger: (l11 = a13.trigger) != null ? l11 : 1 });
}, [3]: (e5, a13) => {
  if (e5.dataRef.current.disabled || e5.listboxState === 1)
    return e5;
  ...
  return u10 === -1 || u10 === e5.activeOptionIndex ? __spreadProps(__spreadValues({}, e5), { searchQuery: l11 }) : __spreadProps(__spreadValues({}, e5), { searchQuery: l11, activeOptionIndex: u10, activationTrigger: 1 });
}, [4](e5) {
  return e5.dataRef.current.disabled || e5.listboxState === 1 || e5.searchQuery === "" ? e5 : __spreadProps(__spreadValues({}, e5), { searchQuery: "" });
}, [5]: (e5, a13) => {
  let n7 = { id: a13.id, dataRef: a13.dataRef }, r9 = z3(e5, (l11) => [...l11, n7]);
  return e5.activeOptionIndex === null && e5.dataRef.current.isSelected(a13.dataRef.current.value) && (r9.activeOptionIndex = r9.options.indexOf(n7)), __spreadValues(__spreadValues({}, e5), r9);
}, [6]: (e5, a13) => {
  let n7 = z3(e5, (r9) => {
    let l11 = r9.findIndex((t17) => t17.id === a13.id);
    return l11 !== -1 && r9.splice(l11, 1), r9;
  });
  return __spreadProps(__spreadValues(__spreadValues({}, e5), n7), { activationTrigger: 1 });
}, [7]: (e5, a13) => __spreadProps(__spreadValues({}, e5), { labelId: a13.id }) };
...
function Qe3(e5, a13) {
  let _a = e5, { value: n7, defaultValue: r9, form: l11, name: t17, onChange: p7, by: u10 = (s17, c14) => s17 === c14, disabled: i9 = false, horizontal: b7 = false, multiple: R3 = false } = _a, m11 = __objRest(_a, ["value", "defaultValue", "form", "name", "onChange", "by", "disabled", "horizontal", "multiple"]);
  ...
  } : u10), A6 = (0, import_react34.useCallback)((s17) => u(d13.mode, { [1]: () => L3.some((c14) => C5(c14, s17)), [0]: () => C5(L3, s17) }), [L3]), d13 = (0, import_react34.useMemo)(() => __spreadProps(__spreadValues({}, T8), { value: L3, disabled: i9, mode: R3 ? 1 : 0, orientation: P4, compare: C5, isSelected: A6, optionsPropsRef: x6, labelRef: E9, buttonRef: B3, optionsRef: W2 }), [L3, i9, R3, T8]);
  l(() => {
...
function Xe3(e5, a13) {
  var y8;
  let n7 = I(), _a = e5, { id: r9 = `headlessui-listbox-button-${n7}` } = _a, l11 = __objRest(_a, ["id"]), t17 = U2("Listbox.Button"), p7 = _2("Listbox.Button"), u10 = y2(t17.buttonRef, a13), i9 = p(), b7 = o4((T8) => {
    switch (T8.key) {
      case o8.Space:
      case o8.Enter:
      case o8.ArrowDown:
...
var $e3 = "label";
function ze3(e5, a13) {
  let n7 = I(), _a = e5, { id: r9 = `headlessui-listbox-label-${n7}` } = _a, l11 = __objRest(_a, ["id"]), t17 = U2("Listbox.Label"), p7 = _2("Listbox.Label"), u10 = y2(t17.labelRef, a13);
...
function Ye3(e5, a13) {
  var T8;
  let n7 = I(), _a = e5, { id: r9 = `headlessui-listbox-options-${n7}` } = _a, l11 = __objRest(_a, ["id"]), t17 = U2("Listbox.Options"), p7 = _2("Listbox.Options"), u10 = y2(t17.optionsRef, a13), i9 = p(), b7 = p(), R3 = C(), m11 = (() => R3 !== null ? (R3 & d5.Open) === d5.Open : t17.listboxState === 0)();
...
var Te = { [1](e5) {
  return e5.menuState === 1 ? e5 : __spreadProps(__spreadValues({}, e5), { activeItemIndex: null, menuState: 1 });
}, [0](e5) {
  return e5.menuState === 0 ? e5 : __spreadProps(__spreadValues({}, e5), { __demoMode: false, menuState: 0 });
}, [2]: (e5, u10) => {
  var s17;
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, e5), r9), { searchQuery: "", activeItemIndex: i9, activationTrigger: (s17 = u10.trigger) != null ? s17 : 1 });
}, [3]: (e5, u10) => {
  ...
  return a13 === -1 || a13 === e5.activeItemIndex ? __spreadProps(__spreadValues({}, e5), { searchQuery: s17 }) : __spreadProps(__spreadValues({}, e5), { searchQuery: s17, activeItemIndex: a13, activationTrigger: 1 });
}, [4](e5) {
  return e5.searchQuery === "" ? e5 : __spreadProps(__spreadValues({}, e5), { searchQuery: "", searchActiveItemIndex: null });
}, [5]: (e5, u10) => {
  let r9 = w5(e5, (i9) => [...i9, { id: u10.id, dataRef: u10.dataRef }]);
  return __spreadValues(__spreadValues({}, e5), r9);
}, [6]: (e5, u10) => {
  let r9 = w5(e5, (i9) => {
    let s17 = i9.findIndex((t17) => t17.id === u10.id);
    return s17 !== -1 && i9.splice(s17, 1), i9;
  });
  return __spreadProps(__spreadValues(__spreadValues({}, e5), r9), { activationTrigger: 1 });
} };
...
function Me2(e5, u10) {
  let _a = e5, { __demoMode: r9 = false } = _a, i9 = __objRest(_a, ["__demoMode"]), s17 = (0, import_react35.useReducer)(ye3, { __demoMode: r9, menuState: r9 ? 0 : 1, buttonRef: (0, import_react35.createRef)(), itemsRef: (0, import_react35.createRef)(), items: [], searchQuery: "", activeItemIndex: null, activationTrigger: 1 }), [{ menuState: t17, itemsRef: o12, buttonRef: a13 }, l11] = s17, m11 = y2(u10);
  h2([a13, o12], (g6, R3) => {
    var p7;
...
function Re(e5, u10) {
  var R3;
  let r9 = I(), _a = e5, { id: i9 = `headlessui-menu-button-${r9}` } = _a, s17 = __objRest(_a, ["id"]), [t17, o12] = O2("Menu.Button"), a13 = y2(t17.buttonRef, u10), l11 = p(), m11 = o4((p7) => {
    switch (p7.key) {
      case o8.Space:
      case o8.Enter:
      case o8.ArrowDown:
...
function Ee(e5, u10) {
  var M11, b7;
  let r9 = I(), _a = e5, { id: i9 = `headlessui-menu-items-${r9}` } = _a, s17 = __objRest(_a, ["id"]), [t17, o12] = O2("Menu.Items"), a13 = y2(t17.itemsRef, u10), l11 = n3(t17.itemsRef), m11 = p(), I6 = C(), A6 = (() => I6 !== null ? (I6 & d5.Open) === d5.Open : t17.menuState === 0)();
...
function Pe2(e5, u10) {
  let r9 = I(), _a = e5, { id: i9 = `headlessui-menu-item-${r9}`, disabled: s17 = false } = _a, t17 = __objRest(_a, ["id", "disabled"]), [o12, a13] = O2("Menu.Item"), l11 = o12.activeItemIndex !== null ? o12.items[o12.activeItemIndex].id === i9 : false, m11 = (0, import_react35.useRef)(null), I6 = y2(u10, m11);
  l(() => {
...
var _e2 = { [0]: (t17) => {
  let o12 = __spreadProps(__spreadValues({}, t17), { popoverState: u(t17.popoverState, { [0]: 1, [1]: 0 }) });
  return o12.popoverState === 0 && (o12.__demoMode = false), o12;
}, [1](t17) {
  return t17.popoverState === 1 ? t17 : __spreadProps(__spreadValues({}, t17), { popoverState: 1 });
}, [2](t17, o12) {
  return t17.button === o12.button ? t17 : __spreadProps(__spreadValues({}, t17), { button: o12.button });
}, [3](t17, o12) {
  return t17.buttonId === o12.buttonId ? t17 : __spreadProps(__spreadValues({}, t17), { buttonId: o12.buttonId });
}, [4](t17, o12) {
  return t17.panel === o12.panel ? t17 : __spreadProps(__spreadValues({}, t17), { panel: o12.panel });
}, [5](t17, o12) {
  return t17.panelId === o12.panelId ? t17 : __spreadProps(__spreadValues({}, t17), { panelId: o12.panelId });
} };
...
function we3(t17, o12) {
  var D6;
  let _a = t17, { __demoMode: u10 = false } = _a, R3 = __objRest(_a, ["__demoMode"]), O4 = (0, import_react36.useRef)(null), n7 = y2(o12, T2((l11) => {
    O4.current = l11;
...
function We4(t17, o12) {
  let u10 = I(), _a = t17, { id: R3 = `headlessui-popover-button-${u10}` } = _a, O4 = __objRest(_a, ["id"]), [n7, e5] = oe2("Popover.Button"), { isPortalled: v5 } = fe2("Popover.Button"), P4 = (0, import_react36.useRef)(null), s17 = `headlessui-focus-sentinel-${I()}`, I6 = Ee2(), p7 = I6 == null ? void 0 : I6.closeOthers, m11 = Ge4() !== null;
...
function Ve3(t17, o12) {
  let u10 = I(), _a = t17, { id: R3 = `headlessui-popover-overlay-${u10}` } = _a, O4 = __objRest(_a, ["id"]), [{ popoverState: n7 }, e5] = oe2("Popover.Overlay"), v5 = y2(o12), P4 = C(), s17 = (() => P4 !== null ? (P4 & d5.Open) === d5.Open : n7 === 0)(), I6 = o4((m11) => {
    if (r2(m11.currentTarget))
      return m11.preventDefault();
    e5({ type: 1 });
...
function Xe4(t17, o12) {
  let u10 = I(), _a = t17, { id: R3 = `headlessui-popover-panel-${u10}`, focus: O4 = false } = _a, n7 = __objRest(_a, ["id", "focus"]), [e5, v5] = oe2("Popover.Panel"), { close: P4, isPortalled: s17 } = fe2("Popover.Panel"), I6 = `headlessui-focus-sentinel-before-${I()}`, p7 = `headlessui-focus-sentinel-after-${I()}`, T8 = (0, import_react36.useRef)(null), m11 = y2(T8, o12, (f14) => {
    v5({ type: 4, panel: f14 });
  }), S10 = n3(T8);
...
function h10(o12, t17) {
  let i9 = I(), _a = o12, { id: e5 = `headlessui-label-${i9}`, passive: s17 = false } = _a, a13 = __objRest(_a, ["id", "passive"]), r9 = u9(), l11 = y2(t17);
  l(() => r9.register(e5), [e5, r9.register]);
  let n7 = __spreadProps(__spreadValues({ ref: l11 }, r9.props), { id: e5 });
...
var ke2 = { [0](r9, o12) {
  ...
  return __spreadProps(__spreadValues({}, r9), { options: I2(t17, (p7) => p7.element.current) });
}, [1](r9, o12) {
  let t17 = r9.options.slice(), p7 = r9.options.findIndex((T8) => T8.id === o12.id);
  return p7 === -1 ? r9 : (t17.splice(p7, 1), __spreadProps(__spreadValues({}, r9), { options: t17 }));
} };
...
var he3 = "div";
function Fe(r9, o12) {
  let t17 = I(), _a = r9, { id: p7 = `headlessui-radiogroup-${t17}`, value: T8, defaultValue: v5, form: S10, name: m11, onChange: M11, by: G2 = (e5, i9) => e5 === i9, disabled: C5 = false } = _a, H7 = __objRest(_a, ["id", "value", "defaultValue", "form", "name", "onChange", "by", "disabled"]), y8 = o4(typeof G2 == "string" ? (e5, i9) => {
    let n7 = G2;
  ...
  }), c14 = o4((e5) => (h11(__spreadValues({ type: 0 }, e5)), () => h11({ type: 1, id: e5.id }))), _7 = (0, import_react39.useMemo)(() => __spreadValues({ value: l11, firstOption: b7, containsCheckedOption: F8, disabled: C5, compare: y8 }, P4), [l11, b7, F8, C5, y8, P4]), ie4 = (0, import_react39.useMemo)(() => ({ registerOption: c14, change: d13 }), [c14, d13]), ae4 = { ref: W2, id: p7, role: "radiogroup", "aria-labelledby": N7, "aria-describedby": k2, onKeyDown: x6 }, pe3 = (0, import_react39.useMemo)(() => ({ value: l11 }), [l11]), w6 = (0, import_react39.useRef)(null), le4 = p();
  return (0, import_react39.useEffect)(() => {
    w6.current && v5 !== void 0 && le4.addEventListener(w6.current, "reset", () => {
      d13(v5);
    });
  }, [w6, d13]), import_react39.default.createElement(U5, { name: "RadioGroup.Description" }, import_react39.default.createElement(R3, { name: "RadioGroup.Label" }, import_react39.default.createElement($3.Provider, { value: ie4 }, import_react39.default.createElement(B.Provider, { value: _7 }, m11 != null && l11 != null && e2({ [m11]: l11 }).map(([e5, i9], n7) => import_react39.default.createElement(c4, __spreadValues({ features: p3.Hidden, ref: n7 === 0 ? (f14) => {
    var u10;
...
function we4(r9, o12) {
  var x6;
  let t17 = I(), _a = r9, { id: p7 = `headlessui-radiogroup-option-${t17}`, value: T8, disabled: v5 = false } = _a, S10 = __objRest(_a, ["id", "value", "disabled"]), m11 = (0, import_react39.useRef)(null), M11 = y2(m11, o12), [G2, C5] = H5(), [H7, y8] = M3(), { addFlag: P4, removeFlag: h11, hasFlag: a13 } = c11(1), N7 = s2({ value: T8, disabled: v5 }), R3 = oe3("RadioGroup.Option"), k2 = ne2("RadioGroup.Option");
...
var ee5 = "button";
function te3(s17, n7) {
  let p7 = I(), _a = s17, { id: c14 = `headlessui-switch-${p7}`, checked: f14, defaultChecked: r9 = false, onChange: h11, name: l11, value: T8, form: b7 } = _a, d13 = __objRest(_a, ["id", "checked", "defaultChecked", "onChange", "name", "value", "form"]), t17 = (0, import_react40.useContext)(y7), u10 = (0, import_react40.useRef)(null), D6 = y2(u10, n7, t17 === null ? null : t17.setSwitch), [o12, a13] = T4(f14, h11, r9), S10 = o4(() => a13 == null ? void 0 : a13(!o12)), C5 = o4((e5) => {
  ...
  }, [u10, a13]), import_react40.default.createElement(import_react40.default.Fragment, null, l11 != null && o12 && import_react40.default.createElement(c4, __spreadValues({ features: p3.Hidden }, R({ as: "input", type: "checkbox", hidden: true, readOnly: true, form: b7, checked: o12, name: l11, value: T8 }))), X({ ourProps: R3, theirProps: d13, slot: G2, defaultTag: ee5, name: "Switch" }));
}
var ne3 = D2(te3);
var re3 = Z6;
...
var ce3 = { [0](e5, n7) {
  ...
  }), r9 = __spreadProps(__spreadValues({}, e5), { tabs: t17, panels: o12 });
  if (n7.index < 0 || n7.index > t17.length - 1) {
    ...
    return __spreadProps(__spreadValues({}, r9), { selectedIndex: l11 === -1 ? e5.selectedIndex : l11 });
  }
  ...
  return c14 === -1 && (c14 = e5.selectedIndex), __spreadProps(__spreadValues({}, r9), { selectedIndex: c14 });
}, [1](e5, n7) {
  var r9;
  ...
  return s17 === -1 && (s17 = e5.selectedIndex), __spreadProps(__spreadValues({}, e5), { tabs: o12, selectedIndex: s17 });
}, [2](e5, n7) {
  return __spreadProps(__spreadValues({}, e5), { tabs: e5.tabs.filter((t17) => t17 !== n7.tab) });
}, [3](e5, n7) {
  return e5.panels.includes(n7.panel) ? e5 : __spreadProps(__spreadValues({}, e5), { panels: I2([...e5.panels, n7.panel], (t17) => t17.current) });
}, [4](e5, n7) {
  return __spreadProps(__spreadValues({}, e5), { panels: e5.panels.filter((t17) => t17 !== n7.panel) });
} };
...
function me3(e5, n7) {
  let _a = e5, { defaultIndex: t17 = 0, vertical: o12 = false, manual: s17 = false, onChange: r9, selectedIndex: i9 = null } = _a, R3 = __objRest(_a, ["defaultIndex", "vertical", "manual", "onChange", "selectedIndex"]);
  ...
  })), y8 = s2(l11.tabs), E9 = (0, import_react42.useMemo)(() => __spreadValues({ orientation: b7, activation: c14 }, l11), [b7, c14, l11]), I6 = o4((p7) => (d13({ type: 1, tab: p7 }), () => d13({ type: 2, tab: p7 }))), A6 = o4((p7) => (d13({ type: 3, panel: p7 }), () => d13({ type: 4, panel: p7 }))), L3 = o4((p7) => {
...
function ye4(e5, n7) {
  var p7, D6;
  let t17 = I(), _a = e5, { id: o12 = `headlessui-tabs-tab-${t17}` } = _a, s17 = __objRest(_a, ["id"]), { orientation: r9, activation: i9, selectedIndex: R3, tabs: b7, panels: c14 } = M8("Tab"), u10 = q4("Tab"), T8 = M8("Tab"), l11 = (0, import_react42.useRef)(null), d13 = y2(l11, n7);
...
function Se3(e5, n7) {
  var E9, I6, A6, L3;
  let t17 = I(), _a = e5, { id: o12 = `headlessui-tabs-panel-${t17}`, tabIndex: s17 = 0 } = _a, r9 = __objRest(_a, ["id", "tabIndex"]), { selectedIndex: i9, tabs: R3, panels: b7 } = M8("Tab.Panel"), c14 = q4("Tab.Panel"), u10 = (0, import_react42.useRef)(null), T8 = y2(u10, n7);
  ...
  return !g6 && ((A6 = r9.unmount) == null || A6) && !((L3 = r9.static) != null && L3) ? import_react42.default.createElement(c4, __spreadValues({ as: "span" }, y8)) : X({ ourProps: y8, theirProps: r9, slot: m11, defaultTag: Re2, features: Le3, visible: g6, name: "Tabs.Panel" });
}
var Ie4 = D2(ye4);
var De3 = D2(me3);
var Fe2 = D2(xe5);
...
function De4(t17, n7) {
  var K4, Q5;
  let _a = t17, { beforeEnter: r9, afterEnter: s17, beforeLeave: y8, afterLeave: D6, enter: c14, enterFrom: x6, enterTo: p7, entered: h11, leave: u10, leaveFrom: v5, leaveTo: d13 } = _a, i9 = __objRest(_a, ["beforeEnter", "afterEnter", "beforeLeave", "afterLeave", "enter", "enterFrom", "enterTo", "entered", "leave", "leaveFrom", "leaveTo"]), e5 = (0, import_react43.useRef)(null), a13 = y2(e5, n7), o12 = (K4 = i9.unmount) == null || K4 ? j.Unmount : j.Hidden, { show: f14, appear: P4, initial: T8 } = Se4(), [l11, j6] = (0, import_react43.useState)(f14 ? "visible" : "hidden"), q5 = Ne5(), { register: O4, unregister: V4 } = q5;
  ...
  return z5 ? R3 = __spreadProps(__spreadValues({}, R3), { className: t6(i9.className, ...k2.current.enter, ...k2.current.enterFrom) }) : (R3.className = t6(i9.className, (Q5 = e5.current) == null ? void 0 : Q5.className), R3.className === "" && delete R3.className), import_react43.default.createElement(M10.Provider, { value: A6 }, import_react43.default.createElement(c5, { value: u(l11, { ["visible"]: d5.Open, ["hidden"]: d5.Closed }) | H7.flags }, X({ ourProps: me4, theirProps: R3, defaultTag: ye5, features: ae3, visible: l11 === "visible", name: "Transition.Child" })));
}
function He5(t17, n7) {
  let _a = t17, { show: r9, appear: s17 = false, unmount: y8 = true } = _a, D6 = __objRest(_a, ["show", "appear", "unmount"]), c14 = (0, import_react43.useRef)(null), x6 = y2(c14, n7);
  l2();
  let p7 = C();
  ...
  return import_react43.default.createElement(M10.Provider, { value: v5 }, import_react43.default.createElement(_6.Provider, { value: a13 }, X({ ourProps: __spreadProps(__spreadValues({}, o12), { as: import_react43.Fragment, children: import_react43.default.createElement(le3, __spreadProps(__spreadValues(__spreadValues({ ref: x6 }, o12), D6), { beforeEnter: f14, beforeLeave: P4 })) }), theirProps: {}, defaultTag: import_react43.Fragment, features: ae3, visible: h11 === "visible", name: "Transition" })));
}
function Fe3(t17, n7) {
  let r9 = (0, import_react43.useContext)(_6) !== null, s17 = C() !== null;
  return import_react43.default.createElement(import_react43.default.Fragment, null, !r9 && s17 ? import_react43.default.createElement(W, __spreadValues({ ref: n7 }, t17)) : import_react43.default.createElement(le3, __spreadValues({ ref: n7 }, t17)));
}
var W = D2(He5);
var le3 = D2(De4);
var Le4 = D2(Fe3);
