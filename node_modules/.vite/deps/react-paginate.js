import {
  require_react
} from "./chunk-RK3ZWQIC.js";
import {
  __commonJS,
  init_define_process_env
} from "./chunk-JTF3BUQH.js";
...
var require_react_paginate = __commonJS({
  "node_modules/react-paginate/dist/react-paginate.js"(exports, module) {
    init_define_process_env();
    !function(e, a) {
      typeof exports == "object" && typeof module == "object" ? module.exports = a(require_react()) : typeof define == "function" && define.amd ? define(["react"], a) : typeof exports == "object" ? exports.ReactPaginate = a(require_react()) : e.ReactPaginate = a(e.React);
    }(exports, (e) => (() => {
      var a = { 703: (e2, a2, t2) => {
        "use strict";
        var r2 = t2(414);
      ...
      return (() => {
        ...
        var o = function(e3) {
          ...
          return i2 && (v2 = "page", b2 = e3.ariaLabel || "Page " + n2 + " is your current page", t3 = t3 !== void 0 ? t3 + " " + o2 : o2, r2 !== void 0 ? l2 !== void 0 && (r2 = r2 + " " + l2) : r2 = l2), a2().createElement("li", { className: t3 }, a2().createElement("a", s({ rel: f2, role: u2 ? void 0 : "button", className: r2, href: u2, tabIndex: i2 ? "-1" : "0", "aria-label": b2, "aria-current": v2, onKeyPress: p2 }, c2(p2)), d2(n2)));
        };
        ...
        const u = p;
        function g(e3) {
          var a3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
          return e3 != null ? e3 : a3;
        }
        function d(e3) {
          return d = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(e4) {
            return typeof e4;
          } : function(e4) {
        ...
        function h(e3, a3) {
          if (a3 && (d(a3) === "object" || typeof a3 == "function"))
            return a3;
          if (a3 !== void 0)
        ...
        var P = function(e3) {
          ...
          function o2(e4) {
            ...
            return function(e5, a3) {
              ...
              var n3 = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, i3 = n3.isPrevious, s3 = i3 !== void 0 && i3, o3 = n3.isNext, l2 = o3 !== void 0 && o3, c2 = n3.isBreak, p2 = c2 !== void 0 && c2, u2 = n3.isActive, g2 = u2 !== void 0 && u2;
              ...
              b2 !== void 0 && t4.handlePageChange(b2);
              ...
              t4.props.onPageChange !== void 0 && typeof t4.props.onPageChange == "function" && t4.props.onPageChange({ selected: e5 });
            }), C(m(t4), "callActiveCallback", function(e5) {
              t4.props.onPageActive !== void 0 && typeof t4.props.onPageActive == "function" && t4.props.onPageActive({ selected: e5 });
              ...
              if (i3 <= n3)
                ...
                for (v2 = 0; v2 < i3; v2++) {
                  ...
                  if (C2 <= s3)
                    ...
                    y2.push({ type: "page", index: v2, display: m2(v2) });
                  else if (v2 >= g2 - f2 && v2 <= g2 + (g2 === 0 && n3 > 1 ? b2 - 1 : b2))
                    y2.push({ type: "page", index: v2, display: m2(v2) });
                ...
                y2.forEach(function(a3, t5) {
                  var r5 = a3;
                  a3.type === "break" && y2[t5 - 1] && y2[t5 - 1].type === "page" && y2[t5 + 1] && y2[t5 + 1].type === "page" && y2[t5 + 1].index - y2[t5 - 1].index <= 2 && (r5 = { type: "page", index: a3.index, display: m2(a3.index) }), e5.push(r5.display);
                });
              }
              return e5;
            }), e4.initialPage !== void 0 && e4.forcePage !== void 0 && console.warn("(react-paginate): Both initialPage (".concat(e4.initialPage, ") and forcePage (").concat(e4.forcePage, ") props are provided, which is discouraged.") + " Use exclusively forcePage prop for a controlled component.\nSee https://reactjs.org/docs/forms.html#controlled-components"), r3 = e4.initialPage ? e4.initialPage : e4.forcePage ? e4.forcePage : 0, t4.state = { selected: r3 }, t4;
          }
          return t3 = o2, (r2 = [{ key: "componentDidMount", value: function() {
            ...
            a3 === void 0 || t4 || this.callCallback(a3), r3 && console.warn("DEPRECATED (react-paginate): The extraAriaContext prop is deprecated. You should now use the ariaLabelBuilder instead."), Number.isInteger(n3) || console.warn("(react-paginate): The pageCount prop value provided is not an integer (".concat(n3, "). Did you forget a Math.ceil()?")), a3 !== void 0 && a3 > n3 - 1 && console.warn("(react-paginate): The initialPage prop provided is greater than the maximum page index from pageCount prop (".concat(a3, " > ").concat(n3 - 1, ").")), i3 !== void 0 && i3 > n3 - 1 && console.warn("(react-paginate): The forcePage prop provided is greater than the maximum page index from pageCount prop (".concat(i3, " > ").concat(n3 - 1, ")."));
          } }, { key: "componentDidUpdate", value: function(e4) {
            this.props.forcePage !== void 0 && this.props.forcePage !== e4.forcePage && (this.props.forcePage > this.props.pageCount - 1 && console.warn("(react-paginate): The forcePage prop provided is greater than the maximum page index from pageCount prop (".concat(this.props.forcePage, " > ").concat(this.props.pageCount - 1, ").")), this.setState({ selected: this.props.forcePage })), Number.isInteger(e4.pageCount) && !Number.isInteger(this.props.pageCount) && console.warn("(react-paginate): The pageCount prop value provided is not an integer (".concat(this.props.pageCount, "). Did you forget a Math.ceil()?"));
